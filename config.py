...
class Config:
    ...
    DISK_USAGE_WARN_GB = settings.DISK_USAGE_WARN_GB
    MAX_DOCKING_PDBS = settings.MAX_DOCKING_PDBS
    DOCKING_TIMEOUT = settings.DOCKING_TIMEOUT
    WORKER_CONCURRENCY = settings.WORKER_CONCURRENCY
    DOCKING_CONCURRENCY = settings.DOCKING_CONCURRENCY
    P2RANK_THREADS = settings.P2RANK_THREADS
    DOCKING_EXHAUSTIVENESS = settings.DOCKING_EXHAUSTIVENESS
    DOCKING_MAX_PAIRS = settings.DOCKING_MAX_PAIRS
    MAX_DOWNLOAD_ZIP_SIZE = settings.MAX_DOWNLOAD_ZIP_SIZE
    MAX_TRAJECTORY_FRAMES = settings.MAX_TRAJECTORY_FRAMES
    MAX_VIEWER_BYTES = settings.MAX_VIEWER_BYTES
    MAX_VIEWER_LOADED_FRAMES = settings.MAX_VIEWER_LOADED_FRAMES
    # Phase C C1 — pool sizing + abuse limits
    FAST_POOL_SIZE = settings.FAST_POOL_SIZE
    DOCKING_POOL_SIZE = settings.DOCKING_POOL_SIZE
    ...
    WORKER_IMAGE_TAG = settings.WORKER_IMAGE_TAG
    ORCHESTRATOR_BACKEND = settings.ORCHESTRATOR_BACKEND
    PER_SESSION_DISK_QUOTA_MB = settings.PER_SESSION_DISK_QUOTA_MB
    MAX_CONCURRENT_FAST_JOBS = settings.MAX_CONCURRENT_FAST_JOBS
    MAX_CONCURRENT_DOCKING_JOBS = settings.MAX_CONCURRENT_DOCKING_JOBS
    MAX_CONCURRENT_FAST_PER_SESSION = settings.MAX_CONCURRENT_FAST_PER_SESSION
    MAX_CONCURRENT_DOCKING_PER_SESSION = settings.MAX_CONCURRENT_DOCKING_PER_SESSION
    MAX_SESSIONS_PER_IP_PER_DAY = settings.MAX_SESSIONS_PER_IP_PER_DAY
    SESSION_GRACE_MINUTES = settings.SESSION_GRACE_MINUTES
    # Phase C C2 — orchestrator runtime
    USE_ORCHESTRATOR = settings.USE_ORCHESTRATOR
    DOCKER_PROXY_URL = settings.DOCKER_PROXY_URL
    ORCHESTRATOR_HTTP_PORT = settings.ORCHESTRATOR_HTTP_PORT
    ORCHESTRATOR_TICK_SECONDS = settings.ORCHESTRATOR_TICK_SECONDS
    WORKER_NETWORK_NAME = settings.WORKER_NETWORK_NAME
    # Demo trajectory (B3.1 + post-launch knob)
    EXAMPLE_TRAJECTORY_DIR = settings.EXAMPLE_TRAJECTORY_DIR
